...
namespace Amazon.MobileAnalytics.Model.Internal.MarshallTransformations
{
        ...
        , ISimplifiedErrorUnmarshaller 
    {
        ...
        {
            if (!string.IsNullOrEmpty(errorResponse.Code) && errorResponse.Code.Equals("BadRequestException"))
            {
                return new BadRequestException(GetDefaultErrorMessage<BadRequestException>(), innerException, ErrorType.Unknown, errorResponse.Code, errorResponse.RequestId, response.StatusCode);
            }
