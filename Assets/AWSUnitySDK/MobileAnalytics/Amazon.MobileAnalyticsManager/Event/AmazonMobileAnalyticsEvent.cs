...
namespace Amazon.MobileAnalyticsManager.Event
{
    ...
    public class AmazonMobileAnalyticsEvent : IAmazonMobileAnalyticsEvent 
    {
        ...
        /// <see cref="Amazon.MobileAnalyticsManager.Event.AmazonMobileAnalyticsManagerEvent"/> class.
        /// </summary>
        public AmazonMobileAnalyticsEvent() : this("defaultEventType")
        {
        } 
        ...
        public AmazonMobileAnalyticsEvent(string eventType)
        {
        ...
        virtual public Amazon.MobileAnalytics.Model.Event ConvertToMobileAnalyticsModelEvent(AmazonMobileAnalyticsSession session)
        {
            ...
            if(this._eventType == AmazonMobileAnalyticsSession.SESSION_STOP_EVENT_TYPE)
            {
